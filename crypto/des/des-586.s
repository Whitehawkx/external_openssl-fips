...
L000pic_point:
	popl	%ebp
	leal	_fips_des_sptrans-L000pic_point(%ebp),%ebp
	movl	24(%esp),%ecx
	cmpl	$0,%ebx
	je	L001decrypt
...
L003pic_point:
	popl	%ebp
	leal	_fips_des_sptrans-L003pic_point(%ebp),%ebp
	movl	24(%esp),%ecx
	cmpl	$0,%ebx
	je	L004decrypt
	call	__x86_DES_encrypt
...
L_DES_decrypt3_begin:
	...
	popl	%ebx
	ret
.globl	_fips_des_ncbc_encrypt
.align	4
_fips_des_ncbc_encrypt:
...
.align	6,0x90
.globl	_fips_des_ede3_cbc_encrypt
.align	4
_fips_des_ede3_cbc_encrypt:
